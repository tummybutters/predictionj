    ...
    <InsetPanel className="rounded-2xl p-3">
      <div className="flex items-start justify-between gap-3">
        <div className="min-w-0">
          ...
          <div className="mt-1 line-clamp-3 text-sm font-semibold text-text/90">
            {prediction.claim}
          </div>
          <div className="mt-2 flex flex-wrap items-center gap-2 text-xs text-muted">
            ...
            <Pill className="px-2 py-1">
              <span className="font-mono">Line {formatPercent(prediction.reference_line)}</span>
            </Pill>
            <Pill className="px-2 py-1">
              <span className="font-mono">Edge {ppEdge(prediction.confidence, prediction.reference_line)}</span>
            </Pill>
      ...
      <div className="mt-4 space-y-4">
        ...
        />
        <PredictionLineControls predictionId={prediction.id} currentLine={prediction.reference_line} />
...
export function ClaimsVisualize({
              ...
              <div className="flex items-start justify-between gap-3">
                <div className="min-w-0">
                  ...
                  <div className="mt-1 flex flex-wrap gap-2 text-[11px] text-muted">
                    ...
                    <span className="font-mono">Line {formatPercent(p.reference_line)}</span>
                  </div>
                </div>
  ...
  return (
    <Panel className={cn("p-4", className)}>
      ...
      <div className="mt-3 grid gap-3 lg:grid-cols-[280px_1fr_340px]">
        {sidebar}
