      ...
      <main className="mx-auto flex min-h-screen w-full max-w-6xl flex-col justify-center px-6 pb-20 pt-28">
        <div className="mx-auto w-full max-w-5xl">
          <div className="mx-auto max-w-3xl text-center">
            ...
            <h1 className="mt-10 text-balance text-5xl font-semibold leading-[0.98] tracking-[-0.035em] text-black/90 sm:text-6xl">
          ...
          <div id="tiers" className="mt-14 grid gap-6 md:grid-cols-3">
            <TierCard
              name="Free"
              price="$0"
          ...
          <section
            id="faq"
            className="mt-16 rounded-3xl border border-white/45 bg-white/14 p-8 shadow-[0_28px_90px_rgba(0,0,0,0.14)] backdrop-blur-xl"
          >
            ...
            <div className="mt-6 grid gap-6 md:grid-cols-2">
              <div>
                ...
                <p className="mt-2 text-sm leading-relaxed text-black/60">
                  Yes. Free is designed to be useful on its own, and you can
                  upgrade later if you want deeper calibration and exports.
                </p>
              </div>
              <div>
                <div className="text-sm font-semibold text-black/80">
          ...
          <section
            id="contact"
            className="mt-8 rounded-3xl border border-white/45 bg-white/14 p-8 shadow-[0_28px_90px_rgba(0,0,0,0.14)] backdrop-blur-xl"
          >
            <h2 className="text-lg font-semibold tracking-[-0.01em] text-black/85">
              Contact us
            </h2>
