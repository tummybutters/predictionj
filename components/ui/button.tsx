  ...
  return (
    <button
      ...
      className={cn(
        ...
        variant === "default" &&
          "bg-gradient-to-b from-accent/95 via-accent to-accent2 text-white shadow-[inset_0_1px_0_rgba(255,255,255,0.22),0_12px_40px_rgba(0,0,0,0.22)] border-b-2 border-accent2/60 hover:border-b-4 hover:-translate-y-[1px] hover:brightness-105 active:translate-y-[0px] active:shadow-[inset_0_1px_0_rgba(255,255,255,0.18),0_12px_40px_rgba(0,0,0,0)] active:border-b-[1pt] transition-all duration-500",
        variant === "secondary" &&
        ...
        variant === "ghost" && "text-text hover:bg-panel/45 active:bg-panel/55",
